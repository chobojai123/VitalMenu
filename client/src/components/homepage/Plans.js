...
const Plans = () => {
  return (
    <section className="section-plans js--section-plans" id="signup">
      <div className="row">
        ...
        <div className="col span-1-of-3">
          <div className="plan-box">
            ...
            <div>
              <ul>
                <li>
                  <i className="ion-ios-checkmark-empty icon-small" />1 meal 10
                  days/month
                </li>
                <li>
                  <i className="ion-ios-checkmark-empty icon-small" />
          ...
          <div className="plan-box">
            ...
            <div>
              <ul>
                ...
                <li>
                  <i className="ion-ios-close-empty icon-small" />
                </li>
                <li>
                  <i className="ion-ios-checkmark-empty icon-small" />
                  Free delivery
